...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return showAllDetails; });\n/* harmony import */ var _mapSet_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mapSet.js */ \"./app/mapSet.js\");\n/* harmony import */ var _consts_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./consts.js */ \"./app/consts.js\");\n\n\nfunction showAllDetails(location, weather, threeDaysWeather) {\n  var degreesLa = Math.floor(location.latitude);\n  var minutesLa = Math.floor((location.latitude - degreesLa) * 60);\n  var degreesLong = Math.floor(location.longtitude);\n  var minutesLong = Math.floor((location.longtitude - degreesLong) * 60);\n  var firstDayName = document.querySelector('.weather-week__first-day .weather-week__day');\n  var secondDayName = document.querySelector('.weather-week__second-day .weather-week__day');\n  var thirdDayName = document.querySelector('.weather-week__third-day .weather-week__day');\n  _consts_js__WEBPACK_IMPORTED_MODULE_1__[\"latitude\"].textContent = \"Latitude: \".concat(degreesLa, \"\\xB0 \").concat(minutesLa, \"'\");\n  _consts_js__WEBPACK_IMPORTED_MODULE_1__[\"longtitude\"].textContent = \"Longtitude: \".concat(degreesLong, \"\\xB0 \").concat(minutesLong, \"'\");\n\n  if (location.country === \"\") {\n    _consts_js__WEBPACK_IMPORTED_MODULE_1__[\"region\"].textContent = \"\".concat(location.city);\n  } else {\n    _consts_js__WEBPACK_IMPORTED_MODULE_1__[\"region\"].textContent = \"\".concat(location.city, \", \").concat(location.country);\n  }\n\n  _consts_js__WEBPACK_IMPORTED_MODULE_1__[\"temperatureToday\"].textContent = \"\".concat(weather.temp, \"\\xB0\");\n  _consts_js__WEBPACK_IMPORTED_MODULE_1__[\"temperatureFeels\"].textContent = \"\".concat(weather.tempFeels, \"\\xB0\");\n  _consts_js__WEBPACK_IMPORTED_MODULE_1__[\"windToday\"].textContent = \"WIND: \".concat(weather.wind, \" m/s\");\n  _consts_js__WEBPACK_IMPORTED_MODULE_1__[\"humidityToday\"].textContent = \"HUMIDITY: \".concat(weather.humidity, \"%\");\n  _consts_js__WEBPACK_IMPORTED_MODULE_1__[\"firstDayContainer\"].textContent = \"\".concat(threeDaysWeather.firstDayTemp, \"\\xB0\");\n  _consts_js__WEBPACK_IMPORTED_MODULE_1__[\"secondDayContainer\"].textContent = \"\".concat(threeDaysWeather.secondDayTemp, \"\\xB0\");\n  _consts_js__WEBPACK_IMPORTED_MODULE_1__[\"thirdDayContainer\"].textContent = \"\".concat(threeDaysWeather.thirdDayTemp, \"\\xB0\");\n  firstDayName.textContent = \"\".concat(_consts_js__WEBPACK_IMPORTED_MODULE_1__[\"days\"][threeDaysWeather.firstDayNumber]).toUpperCase();\n  secondDayName.textContent = \"\".concat(_consts_js__WEBPACK_IMPORTED_MODULE_1__[\"days\"][threeDaysWeather.secondDayNumber]).toUpperCase();\n  thirdDayName.textContent = \"\".concat(_consts_js__WEBPACK_IMPORTED_MODULE_1__[\"days\"][threeDaysWeather.thirdDayNumber]).toUpperCase();\n  Object(_mapSet_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(location.latitude, location.longtitude);\n}\n\n//# sourceURL=webpack:///./app/showAllDetails.js?");
